...
const Navbar = () => {
  ...
  return (
    <>
      <img src={banner} alt="banner-img" className={`absolute -z-10  
        ${show ? "h-[1550px] " : "h-auto"} `} />
      <nav className="text-white shadow-lg pt-[26px]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex space-x-6 items-center">
              ...
              <Link to="/transcations" className="hover:text-gray-400">Transaction</Link>
        ...
        {isOpen && (
          <div className="md:hidden px-2 pt-2 pb-3 space-y-1 bg-gray-700">
            <Link to="/home" className="block px-3 py-2 rounded-md text-white hover:bg-gray-600">Home</Link>
            <Link to="/transcations" className="block px-3 py-2 rounded-md text-white hover:bg-gray-600">transcations</Link>
